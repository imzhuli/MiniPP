...
static constexpr const xPacketCommandId Cmd_PA_RL_CreateConnection     = Cmd_PA_RL_Base + 0x02;
static constexpr const xPacketCommandId Cmd_PA_RL_CreateConnectionResp = Cmd_PA_RL_Base + 0x02;
static constexpr const xPacketCommandId Cmd_PA_RL_PostData             = Cmd_PA_RL_Base + 0x03;
static constexpr const xPacketCommandId Cmd_PA_RL_DestroyConnection    = Cmd_PA_RL_Base + 0x04;
static constexpr const xPacketCommandId Cmd_PA_RL_ProxyClientNotify    = Cmd_PA_RL_Base + 0x05;
